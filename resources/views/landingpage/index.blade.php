...
@section('content')
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <img src="landingpage-assets/assets/img/hero-bg.jpg" alt="" data-aos="fade-in">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                        <img src="landingpage-assets/assets/img/about.jpg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="course-item">
                            <img src="landingpage-assets/assets/img/course-1.jpg" class="img-fluid" alt="...">
                            <div class="course-content">
                                ...
                                <div class="trainer d-flex justify-content-between align-items-center">
                                    <div class="trainer-profile d-flex align-items-center">
                                        <img src="landingpage-assets/assets/img/trainers/trainer-1-2.jpg"
                                            class="img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                        data-aos-delay="200">
                        <div class="course-item">
                            <img src="landingpage-assets/assets/img/course-2.jpg" class="img-fluid" alt="...">
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="trainer d-flex justify-content-between align-items-center">
                                    <div class="trainer-profile d-flex align-items-center">
                                        <img src="landingpage-assets/assets/img/trainers/trainer-2-2.jpg"
                                            class="img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
                        data-aos-delay="300">
                        <div class="course-item">
                            <img src="landingpage-assets/assets/img/course-3.jpg" class="img-fluid" alt="...">
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="trainer d-flex justify-content-between align-items-center">
                                    <div class="trainer-profile d-flex align-items-center">
                                        <img src="landingpage-assets/assets/img/trainers/trainer-3-2.jpg"
                                            class="img-fluid" alt="">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <img src="landingpage-assets/assets/img/trainers/trainer-1.jpg" class="img-fluid"
                                alt="">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <img src="landingpage-assets/assets/img/trainers/trainer-2.jpg" class="img-fluid"
                                alt="">
                            <div class="member-content">
                                <h4>Sarah Jhinson</h4>
                                <span>Marketing</span>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <img src="landingpage-assets/assets/img/trainers/trainer-3.jpg" class="img-fluid"
                                alt="">
                            <div class="member-content">
